...
As mentioned on :ref:`docs-contribute` you can contribute to the
documentation by editing directly on Github. This can be used for
minor changes.
...
docker, you will get the best results. The docker container uses the
...
back to the official documentation from time to time and familiarize
